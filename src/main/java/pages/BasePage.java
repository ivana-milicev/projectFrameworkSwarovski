...
//  Variables:
    ...
    protected By resultPageHeadingLocator = By.cssSelector(".swa-filter-desktop__results-count.swa-text-sans--comment");
...
//    Actions:
    ...
    public String resultPageHeadingCheck () {
        wait.until(ExpectedConditions.visibilityOfElementLocated(resultPageHeadingLocator));
        return driver.findElement(resultPageHeadingLocator).getText();
    }
